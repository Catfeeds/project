...
class WeixinController extends ApiController {
    public function index(){
	   			...
	   			switch ($event['event']) {
	   				...
	   				case wx\Wechat::EVENT_MENU_CLICK:
	   					...
	   					switch ($event['key']) {
	   						//企业简介
	   						case 'qiyejianjie':
								$text = "        中标华信(北京)认证中心有限公司（简称CSHCC）是经中国认证认可监督管理委员会（CNCA）正式批准的综合类认证服务实体。中标华信(北京)认证中心首批获得认监委批准并首个获得服务认证资格的认证机构。机构同时具有质量、环境、职业健康安全管理体系认证资格，一次认证可同时颁发管理体系认证和服务认证证书。为有需求的认证客户提供方便的专业化一站式服务。
        ...
        中标华信(北京)认证中心中文网站（www.cshcc.cn），网站面向全国宣传中心的认证工作，也是获证企业获证后的服务之家，为所有关注认证事业的企业及同仁提供一个信息交流沟通的平台。
...
邮编：100049
电话：010-88255986
E-mail:cshcc@cshcc.cn
简历投递：cshcc_cn@163.com
网址：www.cshcc.cn";
			   					$weObj->text($text)->reply();
			   					break;
