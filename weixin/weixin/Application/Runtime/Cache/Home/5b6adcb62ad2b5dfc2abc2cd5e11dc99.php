...
<html lang="en">
	...
	<body class="login-layout">
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form id='login'>
												<input type="hidden" name="unionToken" value="<?php echo ($wxuser["open_id"]); ?>">
												<input type="hidden" name="unionType"  value="4">
												<fieldset>
													...
													<div class="clearfix">
														<!-- <label class="inline">
															<input type="checkbox" name='is_record' class="ace" />
		...
		<script src="/weixin/weixin/Public/style/js/login/index.js"></script>
		<!-- <![endif]-->
		<!--[if IE]>
